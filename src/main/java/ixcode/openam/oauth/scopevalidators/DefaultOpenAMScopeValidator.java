 ...
 * endpoints as well.
 *
 * This is copied from https://github.com/OpenRock/OpenAM/blob/master/openam-oauth2/src/main/java/org/forgerock/openam/oauth2/OpenAMScopeValidator.java
 *
 * @since 12.0.0
 */
@Singleton
public class DefaultOpenAMScopeValidator implements ScopeValidator {
     ...
     */
    @Inject
    public DefaultOpenAMScopeValidator(IdentityManager identityManager, OpenIDTokenIssuer openIDTokenIssuer,
